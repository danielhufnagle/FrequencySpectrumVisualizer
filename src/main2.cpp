...
const float freq_band_end_hz[freq_band_count] = {1397, 2774, 4151, 5528, 6905, 8282, 9659, 11036, 12413, 13790, 15167, 16544, 17921, 19298, 20675, 22050}; // Fill this in appropriately
const float freq_band_amp[freq_band_count]   = {50, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 500, 505, 500}; // Fill this in appropriately
